...
class GoodsReceipt(Base):
    ...
    # §11.18: weighbridge slip is part of the QC evidence for steel-by-weight (Domain_QA Q7)
    weighbridge_weight: Mapped[Decimal | None] = mapped_column(Qty)
    weighbridge_slip_photo_id: Mapped[int | None] = mapped_column(ForeignKey("files.id"))
